...
public class SolutionNine {
	...
	private static void deleteStudentAndAddress(List<Student> studentList, List<Address> addressList, int deleteId, String studentFilePath, String addressFilePath) {
